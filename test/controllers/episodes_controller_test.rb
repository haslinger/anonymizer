...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { name: @episode.name, podcast: @episode.podcast } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { name: @episode.name, podcast: @episode.podcast } }
