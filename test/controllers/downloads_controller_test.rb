...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post downloads_url, params: { download: { day: @download.day, episode_id: @download.episode_id, size: @download.size } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { day: @download.day, episode_id: @download.episode_id, size: @download.size } }
