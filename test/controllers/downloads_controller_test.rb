...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post downloads_url, params: { download: { count: @download.count, day: @download.day, episode_id: @download.episode_id, hits: @download.hits, volume: @download.volume } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { count: @download.count, day: @download.day, episode_id: @download.episode_id, hits: @download.hits, volume: @download.volume } }
